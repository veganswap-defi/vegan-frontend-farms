...
const Nfts: Nft[] = [
  ...
  {
    name: "Veganston Easter '21",
    description: 'Melting Easter eggs and melting hearts!',
    images: {
      lg: 'veganston-easter-21-lg.png',
      md: 'veganston-easter-21-md.png',
      sm: 'veganston-easter-21-sm.png',
      ipfs: 'https://gateway.pinata.cloud/ipfs/QmZGqWaovULNEMKxBCGnGjh27JQkAyadS6AW4J4Lzf3XBp/easter-veganr.png',
    },
    sortOrder: 999,
    identifier: 'easter-veganr',
    type: NftType.PANCAKE,
    variationId: 15,
  },
  {
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master VEGAN chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of VEGAN.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's VEGAN)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
