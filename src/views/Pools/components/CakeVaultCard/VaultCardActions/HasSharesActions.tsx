...
const HasSharesActions: React.FC<HasStakeActionProps> = ({
  ...
  const { veganAsBigNumber, veganAsDisplayBalance } = convertSharesToVegan(userInfo.shares, pricePerFullShare)

  const stakedDollarValue = formatNumber(
    getBalanceNumber(veganAsBigNumber.multipliedBy(stakingTokenPrice), stakingToken.decimals),
  )
  ...
  return (
    <Flex justifyContent="space-between" alignItems="center">
      <Flex flexDirection="column">
        <Heading>{veganAsDisplayBalance}</Heading>
