...
import { useVegan, useCakeVaultContract } from 'hooks/useContract'
...
const CakeVaultCardActions: React.FC<{
  ...
  useEffect(() => {
    const checkApprovalStatus = async () => {
      try {
        const response = await veganContract.methods.allowance(account, cakeVaultContract.options.address).call()
    ...
    checkApprovalStatus()
  }, [account, veganContract, cakeVaultContract, lastUpdated])
