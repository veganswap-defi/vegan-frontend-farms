...
const TradingCompetition = () => {
  ...
  const { hasUserClaimed, userVeganRewards, userPointReward, canClaimNFT } = userTradingInformation

  const userCanClaimPrizes =
    currentPhase.state === CLAIM &&
    !hasUserClaimed &&
    (userVeganRewards !== '0' || userPointReward !== '0' || canClaimNFT)
